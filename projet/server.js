...
io.on('connection', (socket) => {
  ...
  socket.on('join_game', function (data) {
    ...
    fetch(`http://135.125.101.210:5000/deck/${game_id}/${user}`)
      .then(response => response.json())
    ...
    fetch(`http://135.125.101.210:5000/pot/${game_id}`)
      .then(response => response.json())
  ...
  socket.on('chgpile', (data) => {
    ...
    let newpile = [];
    fetch(`http://135.125.101.210:5000/potd/${game_id}`)
    newCards.map((value, key) => {
      const fetchmsg = `http://135.125.101.210:5000/pots/${game_id}/` + String(value)
      newpile.push(value)
  ...
  socket.on('delcard', (data) => {
    ...
    for (let i = 0; i < selCard.length; i++) {
      ...
      fetch(`http://135.125.101.210:5000/dcard/${game_id}/${user}/` + String(selCard[i]))
  ...
  socket.on('finishTurn', (data) => {
    ...
    fetch('http://135.125.101.210:5000/toggle/', {
                method: 'POST',
                headers: {
                    Accept: 'application/json',
                    'Content-Type': 'application/json',
  ...
  socket.on('requestUpdate', (data)=> {
    const game_id= socket.channel
    fetch(`http://135.125.101.210:5000/ccount/${game_id}/${data}`)
      .then(response => response.json())
      .then(json => { socket.emit('updateCards', json) })
  })
  ...
  socket.on('delCardFinish', (data)=>{
    ...
    fetch('http://135.125.101.210:5000/rank', {
      method: 'POST',
      headers: {
          Accept: 'application/json',
          'Content-Type': 'application/json',
  ...
  socket.on('gameIsFinished', async (data)=> {
    ...
    await fetch('http://135.125.101.210:5000/toggle/', {
      method: 'POST',
      headers: {
          Accept: 'application/json',
          'Content-Type': 'application/json',
    ...
    await fetch('http://135.125.101.210:5000/rank', {
      method: 'POST',
      headers: {
          Accept: 'application/json',
          'Content-Type': 'application/json',
  ...
  socket.on('sendDataHistory', async (data) => {
    for(let i=0; i < data.length; i++){
      await fetch('http://135.125.101.210:5000/history/set/', {
        method: 'POST',
        headers: {
            Accept: 'application/json',
            'Content-Type': 'application/json',
      ...
      await fetch('http://135.125.101.210:5000/toggle/zero', {
        method: 'POST',
        headers: {
            Accept: 'application/json',
            'Content-Type': 'application/json',
    ...
    await fetch('http://135.125.101.210:5000/deck/wipe', {
      method: 'DELETE',
      headers: {
          Accept: 'application/json',
          'Content-Type': 'application/json',
    ...
    await fetch('http://135.125.101.210:5000/deck', {
      method: 'POST',
      headers: {
          Accept: 'application/json',
          'Content-Type': 'application/json',
  ...
  socket.on('exchangeCards', async (data)=>{
    ...
    if(num === 1){
      ...
      await fetch(`http://135.125.101.210:5000/icard/${socket.channel}/${recieveUsr}/${card1}`)
    }
    else if(num ===2){
      const card1 = data.cards[0]
      const card2 = data.cards[1]
      await fetch(`http://135.125.101.210:5000/dcard/${socket.channel}/${usr}/${card1}`)
      await fetch(`http://135.125.101.210:5000/dcard/${socket.channel}/${usr}/${card2}`)
      await fetch(`http://135.125.101.210:5000/icard/${socket.channel}/${recieveUsr}/${card1}`)
      await fetch(`http://135.125.101.210:5000/icard/${socket.channel}/${recieveUsr}/${card2}`)
    }
    await fetch(`http://135.125.101.210:5000/toggle/zero`, {
      method: 'POST',
      headers: {
  ...
  socket.on('retrieveCards', (data) => {
    fetch(`http://135.125.101.210:5000/deck/${socket.channel}/${data}`)
      .then(response => response.json())
...
ioLobby.on('connection', (socket) => {
  ...
  socket.on('createLobby', (data) => {
    ...
    try {
      ...
      fetch('http://135.125.101.210:5000/table', {
        method: 'POST',
        headers: {
          Accept: 'application/json',
          'Content-Type': 'application/json',
      ...
      fetch('http://135.125.101.210:5000/spool', {
        method: 'POST',
        headers: {
          Accept: 'application/json',
          'Content-Type': 'application/json',
      ...
      fetch('http://135.125.101.210:5000/lobby', {
        method: 'POST',
        headers: {
          Accept: 'application/json',
          'Content-Type': 'application/json',
      ...
      fetch('http://135.125.101.210:5000/icount', {
        method: 'POST',
        headers: {
          Accept: 'application/json',
          'Content-Type': 'application/json',
  ...
  socket.on('repGameCreated', async (data) => {
    ...
    try {
      ...
      await fetch(`http://135.125.101.210:5000/lobby/${socket.gameId}`)
        .then(response => response.json())
        .then(json => {
          const yes = json
  ...
  socket.on('playerLeaving', async (data) => {
    ...
    const gameId = data.gid
    try {
      await fetch('http://135.125.101.210:5000/lobbyr', {
        method: 'DELETE',
        headers: {
          Accept: 'application/json',
          'Content-Type': 'application/json',
      ...
      await fetch('http://135.125.101.210:5000/dcount', {
        method: 'POST',
        headers: {
          Accept: 'application/json',
          'Content-Type': 'application/json',
      ...
      fetch(`http://135.125.101.210:5000/lobby/${gameId}`)
        .then(response => response.json())
        .then(json => {
  ...
  socket.on('ownerLeaving', async (data) => {
    ...
    try {
      fetch('http://135.125.101.210:5000/poold', {
        method: 'DELETE',
        headers: {
          Accept: 'application/json',
          'Content-Type': 'application/json',
      ...
      fetch('http://135.125.101.210:5000/delete', {
